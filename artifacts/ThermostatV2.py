...
#    4          Safe sensor/LCD/serial I/O; optional smoothing + hysteresis; minor refactor
# ------------------------------------------------------------------
...
##
## Additional helpers for optional smoothing
##
...
##
## Tunable parameters (Category One: grouped config; Category Two: set to defaults to disable)
##
    ...
    def updateLights(self):
        ...
        if state == "heat":
            if temp < (self.setPoint - HYSTERESIS_F):
                ...
                # inside the band, keep steady light
                redLight.value = 1.0
            return
